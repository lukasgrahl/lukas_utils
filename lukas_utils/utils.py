...
def save_pd_df(df, file_name: str,):
    file_type = file_name.split('.')[-1]
...
def write_to_txt(output: str, file_name, file_dir: str):
...
def save_pkl(file: dict, f_name: str, f_path: str):
...
def save_fig(fig, f_name: str, f_path: str):
    fig.savefig(os.path.join(f_path, f_name))
    pass


def load_pickle(f_name: str, f_path: str):
